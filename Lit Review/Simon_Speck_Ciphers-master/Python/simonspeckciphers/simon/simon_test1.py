...
if __name__ == "__main__":
    ...
    k = random_with_N_digits(16)

    w = SimonCipher(k, key_size=64, block_size=32)
    ...
    print ("Testing the Simon crypotgraphic algorithm")
    ...
    ciphertext = w.encrypt(0x4564656c)
    ...
    decrypted = w.decrypt(ciphertext)
    print ("The decrypted ciphertext is " + str(decrypted))
    ...
    decrypted_decoded = hex(decrypted)
    hex_string = decrypted_decoded[2:]
